    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl w-[90%] max-w-2xl max-h-[90vh] overflow-auto shadow-xl animate-[slideIn_0.3s_ease-out]">
        <div className="flex justify-between items-center px-6 py-5 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-800">{actionType === "encrypt" ? "Encrypt" : "Decrypt"} with Mobile Device</h2>
        ...
        <div className="p-6 md:flex md:items-start md:gap-6">
          ...
          <div className="flex-1 space-y-4">
            <div className="flex items-center gap-4">
              ...
              <p className="text-gray-600">Open the VaultysID mobile app on your phone</p>
            </div>
            <div className="flex items-center gap-4">
        ...
        <div className="px-6 py-4 border-t border-gray-200">
          ...
          <div className="h-1.5 bg-gray-100 rounded overflow-hidden">
            <div className={`h-full bg-indigo-600 rounded transition-all duration-300 ${isConnected ? "w-2/3" : isComplete ? "w-full" : "w-1/5"}`}></div>
          </div>
        </div>
